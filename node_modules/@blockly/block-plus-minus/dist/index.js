 ...
 * SPDX-License-Identifier: Apache-2.0
 */
delete s.a.Blocks.lists_create_with,s.a.defineBlocksWithJsonArray([{type:"lists_create_with",message0:"%{BKY_LISTS_CREATE_EMPTY_TITLE} %1",args0:[{type:"input_dummy",name:"EMPTY"}],output:"Array",style:"list_blocks",helpUrl:"%{BKY_LISTS_CREATE_WITH_HELPURL}",tooltip:"%{BKY_LISTS_CREATE_WITH_TOOLTIP}",mutator:"new_list_create_with_mutator"}]);const p={itemCount_:0,mutationToDom:function(){const t=s.a.utils.xml.createElement("mutation");return t.setAttribute("items",this.itemCount_),t},domToMutation:function(t){const e=parseInt(t.getAttribute("items"),10);this.updateShape_(e)},updateShape_:function(t){for(;this.itemCount_<t;)this.addPart_();for(;this.itemCount_>t;)this.removePart_();this.updateMinus_()},plus:function(){this.addPart_(),this.updateMinus_()},minus:function(){0!=this.itemCount_&&(this.removePart_(),this.updateMinus_())},addPart_:function(){0==this.itemCount_?(this.removeInput("EMPTY"),this.topInput_=this.appendValueInput("ADD"+this.itemCount_).appendField(u(),"PLUS").appendField(s.a.Msg.LISTS_CREATE_WITH_INPUT_WITH)):this.appendValueInput("ADD"+this.itemCount_),this.itemCount_++},removePart_:function(){this.itemCount_--,this.removeInput("ADD"+this.itemCount_),0==this.itemCount_&&(this.topInput_=this.appendDummyInput("EMPTY").appendField(u(),"PLUS").appendField(s.a.Msg.LISTS_CREATE_EMPTY_TITLE))},updateMinus_:function(){const t=this.getField("MINUS");!t&&this.itemCount_>0?this.topInput_.insertFieldAt(1,o(),"MINUS"):t&&this.itemCount_<1&&this.topInput_.removeField("MINUS")}};s.a.Extensions.registerMutator("new_list_create_with_mutator",p,(function(){this.getInput("EMPTY").insertFieldAt(0,u(),"PLUS"),this.updateShape_(3)})),
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
s.a.Msg.PROCEDURE_VARIABLE="variable:",delete s.a.Blocks.procedures_defnoreturn,delete s.a.Blocks.procedures_defreturn,s.a.defineBlocksWithJsonArray([{type:"procedures_defnoreturn",message0:"%{BKY_PROCEDURES_DEFNORETURN_TITLE} %1 %2",message1:"%{BKY_PROCEDURES_DEFNORETURN_DO} %1",args0:[{type:"field_input",name:"NAME",text:""},{type:"input_dummy",name:"TOP"}],args1:[{type:"input_statement",name:"STACK"}],style:"procedure_blocks",helpUrl:"%{BKY_PROCEDURES_DEFNORETURN_HELPURL}",tooltip:"%{BKY_PROCEDURES_DEFNORETURN_TOOLTIP}",extensions:["get_procedure_def_no_return","procedure_context_menu","procedure_rename","procedure_vars"],mutator:"procedure_def_mutator"},{type:"procedures_defreturn",message0:"%{BKY_PROCEDURES_DEFRETURN_TITLE} %1 %2",message1:"%{BKY_PROCEDURES_DEFRETURN_DO} %1",message2:"%{BKY_PROCEDURES_DEFRETURN_RETURN} %1",args0:[{type:"field_input",name:"NAME",text:""},{type:"input_dummy",name:"TOP"}],args1:[{type:"input_statement",name:"STACK"}],args2:[{type:"input_value",align:"right",name:"RETURN"}],style:"procedure_blocks",helpUrl:"%{BKY_PROCEDURES_DEFRETURN_HELPURL}",tooltip:"%{BKY_PROCEDURES_DEFRETURN_TOOLTIP}",extensions:["get_procedure_def_return","procedure_context_menu","procedure_rename","procedure_vars"],mutator:"procedure_def_mutator"}]);s.a.Extensions.registerMixin("get_procedure_def_no_return",{getProcedureDef:function(){const t=this.argData_.map(t=>t.model.name);return[this.getFieldValue("NAME"),t,!1]},callType_:"procedures_callnoreturn"});s.a.Extensions.registerMixin("get_procedure_def_return",{getProcedureDef:function(){const t=this.argData_.map(t=>t.model.name);return[this.getFieldValue("NAME"),t,!0]},callType_:"procedures_callreturn"});const c={customContextMenu:function(t){if(this.isInFlyout)return;const e=this.getFieldValue("NAME"),n=s.a.Msg.PROCEDURES_CREATE_DO.replace("%1",e),i=s.a.utils.xml.createElement("block");i.setAttribute("type",this.callType_),i.appendChild(this.mutationToDom(!0));const o=s.a.ContextMenu.callbackFactory(this,i);if(t.push({enabled:!0,text:n,callback:o}),this.isCollapsed())return;const a=this.getVarModels();for(const e of a){const n=s.a.Msg.VARIABLES_SET_CREATE_GET.replace("%1",e.name),i=s.a.utils.xml.createElement("block");i.setAttribute("type","variables_get"),i.appendChild(s.a.Variables.generateVariableFieldDom(e));const o=s.a.ContextMenu.callbackFactory(this,i);t.push({enabled:!0,text:n,callback:o})}}};s.a.Extensions.registerMixin("procedure_context_menu",c);const m={mutationToDom:function(t=!1){const e=s.a.utils.xml.createElement("mutation");return t&&e.setAttribute("name",this.getFieldValue("NAME")),this.argData_.forEach(n=>{const i=s.a.utils.xml.createElement("arg"),o=n.model;i.setAttribute("name",o.name),i.setAttribute("varid",o.getId()),i.setAttribute("argid",n.argId),t&&i.setAttribute("paramid",n.argId),e.appendChild(i)}),this.hasStatements_||e.setAttribute("statements","false"),e},domToMutation:function(t){this.hasStatements_="false"!==t.getAttribute("statements"),this.hasStatements_||this.removeInput("STACK");const e=[],n=[],i=[];for(const s of t.childNodes)"arg"==s.nodeName.toLowerCase()&&(e.push(s.getAttribute("name")),n.push(s.getAttribute("varid")||s.getAttribute("varId")),i.push(s.getAttribute("argid")));this.updateShape_(e,n,i)},updateShape_:function(t,e,n){if(t.length!=e.length)throw Error("names and varIds must have the same length.");for(let t=this.argData_.length-1;t>=0;t--)this.removeArg_(this.argData_[t].argId);this.argData_=[];const i=e.length;for(let s=0;s<i;s++)this.addArg_(t[s],e[s],n[s]);s.a.Procedures.mutateCallers(this)},plus:function(){this.addArg_(),s.a.Procedures.mutateCallers(this)},minus:function(t){this.argData_.length&&(this.removeArg_(t),s.a.Procedures.mutateCallers(this))},addArg_:function(t=null,e=null,n=null){if(!this.argData_.length){const t=new s.a.FieldLabel(s.a.Msg.PROCEDURES_BEFORE_PARAMS);this.getInput("TOP").appendField(t,"WITH")}const i=this.argData_.map(t=>t.model.name);t=t||s.a.Variables.generateUniqueNameFromOptions(s.a.Procedures.DEFAULT_ARG,i);const o=s.a.Variables.getOrCreateVariablePackage(this.workspace,e,t,"");n=n||s.a.utils.genUid(),this.addVarInput_(t,n),this.getInput("STACK")?this.moveInputBefore(n,"STACK"):this.moveInputBefore(n,"RETURN"),this.argData_.push({model:o,argId:n})},removeArg_:function(t){this.removeInput(t,!0)&&(1==this.argData_.length&&this.getInput("TOP").removeField("WITH"),this.argData_=this.argData_.filter(e=>e.argId!=t))},addVarInput_:function(t,e){const n=new s.a.FieldTextInput(t,this.validator_);n.onFinishEditing_=this.finishEditing_.bind(n),n.varIdsToDelete_=[],n.preEditVarModel_=null,this.appendDummyInput(e).setAlign(s.a.ALIGN_RIGHT).appendField(o(e)).appendField(s.a.Msg.PROCEDURE_VARIABLE).appendField(n,e)},validator_:function(t){const e=this.getSourceBlock(),n=e.workspace,i=e.argData_,o=e.argData_.find(t=>t.argId==this.name),a=o.model.getId(),r=(t=t.replace(/[\s\xa0]+/g," ").trim()).toLowerCase();if(!t||!i.every(t=>t.argId==this.name||r!=t.model.name.toLowerCase()))return this.preEditVarModel_&&(o.model=this.preEditVarModel_,this.preEditVarModel_=null),s.a.Procedures.mutateCallers(e),null;this.varIdsToDelete_.length||(this.preEditVarModel_=o.model,n.getVariableUsesById(a).every(t=>t.id==e.id||t.getProcedureCall&&t.getProcedureCall()==e.getProcedureDef()[0])&&this.varIdsToDelete_.push(a));let u=n.getVariable(t,"");return u?u.name!=t&&n.renameVariableById(u.getId(),t):(u=n.createVariable(t,""),this.varIdsToDelete_.push(u.getId())),u.getId()!=a&&(o.model=u),s.a.Procedures.mutateCallers(e),t},finishEditing_:function(t){const e=this.getSourceBlock(),n=e.argData_.find(t=>t.argId==this.name).model.getId();this.varIdsToDelete_.forEach(t=>{t!=n&&e.workspace.deleteVariableById(t)}),this.varIdsToDelete_.length=0,this.preEditVarModel_=null}};s.a.Extensions.registerMutator("procedure_def_mutator",m,(function(){this.argData_=[],this.hasStatements_=!0,this.getInput("TOP").insertFieldAt(0,u(),"PLUS")}));s.a.Extensions.register("procedure_rename",(function(){this.getField("NAME").setValidator(s.a.Procedures.rename)}));s.a.Extensions.register("procedure_vars",(function(){const t={getVars:function(){return this.argData_.map(t=>t.model.name)},getVarModels:function(){return this.argData_.map(t=>t.model)},renameVarById:function(t,e){const n=this.argData_.find(e=>e.model.getId()==t);if(!n)return;const i=this.workspace.getVariableById(e),o=i.name;this.addVarInput_(o,e),this.moveInputBefore(e,t),this.removeInput(t),n.model=i,s.a.Procedures.mutateCallers(this)},updateVarName:function(t){const e=t.getId(),n=this.argData_.find(t=>t.model.getId()==e);n&&(this.setFieldValue(t.name,n.argId),n.model=t)}};this.mixin(t,!0)}));
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const h={itemCount_:0,mutationToDom:function(){const t=s.a.utils.xml.createElement("mutation");return t.setAttribute("items",this.itemCount_),t},domToMutation:function(t){const e=parseInt(t.getAttribute("items"),10);this.updateShape_(e)},updateShape_:function(t){for(;this.itemCount_<t;)this.addPart_();for(;this.itemCount_>t;)this.removePart_();this.updateMinus_()},plus:function(){this.addPart_(),this.updateMinus_()},minus:function(){0!=this.itemCount_&&(this.removePart_(),this.updateMinus_())},addPart_:function(){0==this.itemCount_?(this.getInput("EMPTY")&&this.removeInput("EMPTY"),this.topInput_=this.appendValueInput("ADD"+this.itemCount_).appendField(u(),"PLUS").appendField(s.a.Msg.TEXT_JOIN_TITLE_CREATEWITH)):this.appendValueInput("ADD"+this.itemCount_),this.itemCount_++},removePart_:function(){this.itemCount_--,this.removeInput("ADD"+this.itemCount_),0==this.itemCount_&&(this.topInput_=this.appendDummyInput("EMPTY").appendField(u(),"PLUS").appendField(this.newQuote_(!0)).appendField(this.newQuote_(!1)))},updateMinus_:function(){const t=this.getField("MINUS");!t&&this.itemCount_>0?this.topInput_.insertFieldAt(1,o(),"MINUS"):t&&this.itemCount_<1&&this.topInput_.removeField("MINUS")}};s.a.Extensions.unregister("text_join_mutator"),s.a.Extensions.registerMutator("text_join_mutator",h,(function(){this.mixin(s.a.Constants.Text.QUOTE_IMAGE_MIXIN),this.updateShape_(2)}))}])}));
